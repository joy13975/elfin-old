...
def draw(x=None, y=None, z=None, i=None, j=None, k=None, length=20.0, r=1.0, g=1.0, b=1.0, width=1.0 ):
...
def draw_axis():
    draw(0,0,0, 1,0,0, 100, 0,255,255, 10);
    draw(0,0,0, 0,1,0, 100, 255,0,255, 10);
    draw(0,0,0, 0,0,1, 100, 255,255,0, 10);
